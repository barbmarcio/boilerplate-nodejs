...
let RegisterService = class RegisterService {
    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (foundUser) {
                throw new AppError_1.default(AppError_1.AlertMessage.error, `The email ${data.email} is already being used`, CommonMessages_1.CommonMessages.ALREADY_EXISTS);
            }
            ...
            const userCreated = yield this.authRepository.register(authentication_mapper_1.default.toEntity(data));
